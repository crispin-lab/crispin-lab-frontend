...
import type { PageInboundLinkListResult } from "@/lib/api/types";
...
export function usePageInboundLinks(
  ...
  overrides?: QueryOverrides<PageInboundLinkListResult>,
): UseQueryResult<PageInboundLinkListResult, ApiError> {
