...
function DropdownMenuItem({
  ...
  return (
    <MenuPrimitive.Item
      ...
      className={cn(dropdownMenuItemBaseClass, className)}
      {...props}
    />
  );
}
